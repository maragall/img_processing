#!/usr/bin/env python3
"""
registration.main – unified CLI dispatcher with metadata‐driven multi‐channel runs.
...
from registration.rename_stage import rename_stage
from registration.generate_stage import generate_stage
from registration.uniformize_stage import uniformize_stage
from registration.update_coordinates import update_coordinates
from registration.restore_stage import restore_stage

# Import the API from mist_stage
from registration.mist_stage import (
    build_params,
    bean_to_cli_args,
    MISTMain,
    JStringArr,
...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.cmd == "full":
        ...
        # locate metadata file generated by MIST
        ...
        if failed_channels:
            ...
            logger.info("Restoring original filenames and cleaning up padded tiles")
            restore_stage(tile_dir)
            logger.info("Starting coordinate calibration stage")
            update_coordinates(tile_dir)
